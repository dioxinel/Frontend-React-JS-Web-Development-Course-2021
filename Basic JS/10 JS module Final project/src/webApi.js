...
const todoHTML = ({ _id, description, completed }) => {
  return `<div id="${_id}" class="todoItem ${
...
export const insertSingleTodoToHtml = (todo, _id) => {
  const container = document.getElementById("todoList");
  container.innerHTML = `${todoHTML({_id, description: todo, completed: false})}${container.innerHTML}`;
};
